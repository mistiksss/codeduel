...
class RunCodeTests(unittest.TestCase):
    ...
    def test_child_does_not_inherit_parent_secrets(self):
        os.environ['CODEDUEL_SECRET_PROBE'] = 'leaked'
        try:
            result = run_code(
                'import os\nprint(os.environ.get("CODEDUEL_SECRET_PROBE", "none"))',
                '',
                2,
                'python',
            )
            ...
            os.environ.pop('CODEDUEL_SECRET_PROBE', None)
